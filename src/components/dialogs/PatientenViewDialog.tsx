      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-sm">{record.fields.patient_vorname ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Nachname</Label>
            <p className="text-sm">{record.fields.patient_nachname ?? '—'}</p>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{record.fields.telefon_patient ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Benötigte Leistungsarten</Label>
            <p className="text-sm">{Array.isArray(record.fields.leistungsarten) ? record.fields.leistungsarten.map((v: any) => v?.label ?? v).join(', ') : '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Besondere Hinweise</Label>
            <p className="text-sm whitespace-pre-wrap">{record.fields.hinweise_patient ?? '—'}</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
