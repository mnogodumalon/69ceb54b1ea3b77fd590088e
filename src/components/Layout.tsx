...
import { IconAlertCircle, IconArrowBackUp, IconClock, IconFileText, IconLayoutDashboard, IconMenu2, IconUsers } from '@tabler/icons-react';
...
const APP_TITLE = 'Pflegedienstplanung';
...
const navigation = [
  ...
  { name: 'Patienten', href: '/patienten', icon: IconFileText },
  { name: 'Einsatzplanung', href: '/einsatzplanung', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Mitarbeiter', href: '/gateway/apps/69ceb52d96e330096c48597b?template=list_page', icon: IconUsers },
  { name: 'Schichtvorlagen', href: '/gateway/apps/69ceb53214acd954594fe260?template=list_page', icon: IconClock },
  { name: 'Patienten', href: '/gateway/apps/69ceb53225f253045a9822ae?template=list_page', icon: IconFileText },
  { name: 'Einsatzplanung', href: '/gateway/apps/69ceb5338bb9fc220f75985f?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69ceb52d96e330096c48597b?template=list_page"
